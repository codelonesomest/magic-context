...
export default async function (pi: ExtensionAPI): Promise<void> {
	...
	// factory for every child session. OMP Task children first attach the
	// primary-owned lightweight runtime; other in-process children use the
	// AsyncLocalStorage lifecycle marker and skip full registration.
