...
echo "  ✓ Tagged $TAG"
echo "  → No GitHub Actions workflow was started; this fork uses manual triggers only."
echo "  → Create the curated GitHub Release explicitly after verifying the pushed tag."
